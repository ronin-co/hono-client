...
First, install the [package](https://www.npmjs.com/package/hono-ronin) with a package manager of your choice:
...
You can now start inserting records with the [RONIN query syntax](https://ronin.co/docs/queries), or add them on the [RONIN dashboard](http://ronin.co). Everything you can do with the RONIN Hono client, you can also do on the dashboard (creating records, retrieving them, filtering them, updating them, etc).
